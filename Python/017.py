    ...
    if len(str(number)) == 1:
        ...
        if int(str(number)[1]) == 0:
            if int(str(number)[2]) == 0:
                ...
                letters = (
                    ONES[int(str(number)[0])] + "hundredand" + ONES[int(str(number)[2])]
                )
        elif int(str(number)[1]) == 1:
            letters = (
                ONES[int(str(number)[0])]
                + "hundredand"
                + TEN_TO_TWENTY[int(str(number)[2]) + 1]
            )
        else:
            letters = (
                ONES[int(str(number)[0])]
                + "hundredand"
                + TENCE[int(str(number)[1]) - 1]
                + ONES[int(str(number)[2])]
            )
    else:
        letters = "onethousand"
